...
class VideoService:
    ...
    def generate_video_from_architecture(self, architecture: Dict[str, Any], output_dir: str,
        ...
        # Get product image URL from architecture if available
        ...
        for i, scene in enumerate(scenes):
            ...
            try:
                # For the first scene, use product image as keyframe if available
                image_url = product_image_url if scene_number == 1 and product_image_url else None
